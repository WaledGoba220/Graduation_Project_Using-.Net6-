   ...
   jQuery(window).on('load', function (e) {
      ...
      jQuery(".pq-form .pq-applyform .home-1").click(function () {
         ...
         if (email == '' || email == undefined) {
            jQuery("<span class='pq-email-error-message pq-message'>Please fill the field</span>").insertAfter('.pq-form .pq-applyform .e-mail-field');
            result = false;
         }
         else {
         ...
         if (doctor_name == '' || doctor_name == undefined) {
            jQuery("<span class='pq-doctor-name-error-message pq-message'>Please fill the field</span>").insertAfter('.pq-form .pq-applyform .doctor-name-field');
            result = false;
         }
         else {
         ...
         if (disease_name == '' || disease_name == undefined) {
            jQuery("<span class='pq-disease-name-error-message pq-message'>Please fill the field</span>").insertAfter('.pq-form .pq-applyform .disease-name-field');
            result = false;
         }
         else {
         ...
         if (result == true) {
               ...
               data: {'email':email},
               success: function(){
                  jQuery("<span class='pq-thank-you-message text-success ms-5'> Thank You For Filling The form</span>").insertAfter('.pq-applyform .pq-button');
               }
            });
         }
      });
      ...
      jQuery(".pq-applyform .home-4").click(function () {
         ...
         if (patient_name == '' || patient_name == undefined) {
            jQuery("<span class='pq-patient-name-error-message pq-message'>Please fill the field</span>").insertAfter('.apply-form .patient-name-field');
            result = false;
         }
         else {
         ...
         if (email == '' || email == undefined) {
            jQuery("<span class='pq-email-error-message pq-message'>Please fill the field</span>").insertAfter('.pq-applyform #e-mail');
            result = false;
         }
         else {
            jQuery('.pq-email-error-message').remove();
         ...
         if (result == true) {
               ...
               data: {'email':email},
               success: function(){
                  jQuery("<span class='pq-thank-you-message text-success ms-5'> Thank You</span>").insertAfter('.pq-applyform .pq-button');
               }
            });
         }
      });
      ...
      jQuery(".pq-applyform .form-btn").click(function () {
         ...
         var first_name = jQuery('.pq-bg-white .pq-applyform #first-name, .pq-applyform #first-name, .comment-respond .name-field').val();
         var gender = jQuery('#gender').val();
         var patient_name = jQuery('#patient-name').val();
         var phone = jQuery('#phone-number').val();
         var email = jQuery('.pq-bg-white .pq-applyform #e-mail, .pq-applyform-white-bg .pq-applyform #e-mail, .pq-applyform #e-mail').val();
         ...
         if (first_name != undefined) {
            if (first_name == '' || first_name == undefined) {
               jQuery("<span class='pq-name-error-message pq-message'>Please fill the field</span>").insertAfter('.pq-applyform .name-field, .comment-respond .name-field');
               result = false;
            }
            else {
               jQuery('.pq-name-error-message').remove();
         ...
         if (patient_name != undefined) {
            if (patient_name == '' || patient_name == undefined) {
               jQuery("<span class='pq-patient-name-error-message pq-message'>Please fill the field</span>").insertAfter('.pq-applyform .pq-appointment .patient-name-field, .appoinment-form .pq-appointment #patient-name');
               result = false;
         ...
         if (email != undefined) {
            if (email == '' || email == undefined) {
               jQuery("<span class='pq-email-error-message pq-message'>Please fill the field</span>").insertAfter('.pq-bg-white .pq-applyform .e-mail-field, .apply-form .pq-applyform .e-mail-field, .pq-formbox .pq-applyform .e-mail-field, .pq-applyform-white-bg .pq-applyform #e-mail, .pq-form-container .pq-applyform .e-mail-field, .comment-form .e-mail-field, .get-in-touch .e-mail-field, .pq-applyform #e-mail');
               result = false;
            }
            else {
               jQuery('.pq-email-error-message').remove();
      ...
      jQuery(".pq-applyform #form-btn").click(function () {
         ...
         if (result == true) {
            jQuery("<span class='pq-thank-you-message text-success ms-3'>Thank You</span>").insertAfter('.pq-sidebars .pq-applyform .pq-button');
         }
      });
   });
